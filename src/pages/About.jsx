...
const About = () => {
  return (
    <div className="pb-16" style={{ paddingTop: 'var(--navbar-height, 64px)' }}>
      {/* Editorial Hero Header */}
      <div className="relative w-full h-[60vh] overflow-hidden bg-brand-stone mb-20">
        <img
          src="/Images/1.jpg"
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 mb-24">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-5 space-y-6">
            ...
            <h2 className="text-3xl md:text-4xl font-light tracking-tight text-brand-dark leading-tight">
              Habibti <span className="font-serif italic text-brand-gold">/حبيبتي/</span> <br />
              <span className="text-2xl md:text-3xl font-light">"My Love, My Beloved"</span>
            </h2>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 lg:gap-24">
            ...
            <div className="space-y-4">
              ...
              <h3 className="text-2xl font-light tracking-wide text-brand-dark">
